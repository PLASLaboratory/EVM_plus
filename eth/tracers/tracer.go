...
// CaptureState implements the Tracer interface to trace a single step of VM execution.
<<<<<<< HEAD
func (jst *Tracer) CaptureState(env *vm.EVM, pc uint64, op vm.OpCode, gas, cost uint64, memory *vm.Memory, stack *vm.Stack, contract *vm.Contract, depth int, forFallback vm.ForFallback, err error) error {
=======
...
>>>>>>> 706f5e3b98a419e8b93653d21876b74a60ab3ee6
	if jst.err == nil {
		...
		//Sooyeon LEE 20190410 add for fallback
		jst.forFallbackWrapper.fbFlag = forFallback
...
// while running an opcode.
<<<<<<< HEAD
func (jst *Tracer) CaptureFault(env *vm.EVM, pc uint64, op vm.OpCode, gas, cost uint64, memory *vm.Memory, stack *vm.Stack, contract *vm.Contract, depth int, forFallback vm.ForFallback, err error) error {
=======
