...
type StructLog struct {
	...
	//Sooyeon LEE 2020.02.25 add value in struct
...
<<<<<<< HEAD
	//Sooyeon LEE 2020.02.25 add argument fallbackFlagforNow
...
<<<<<<< HEAD
//Sooyeon LEE 2020.02.25 add parameter
...
func WriteTrace(writer io.Writer, logs []StructLog) {
	for _, log := range logs {
		//Sooyeon LEE 2020.02.25 add print statement for fallback values
