...
//Callstack is call stack for each interpreter
//Sooyeon LEE 2020.02.25
//var Callstack = NewCallStack()
...
func (in *EVMInterpreter) Run(contract *Contract, input []byte, readOnly bool) (ret []byte, err error) {
	...
	var (
		...
		//Sooyeon LEE 2020.02.27
		//Callstack = NewCallStack()
		//Sooyeon LEE 2020.08.25
	...
	/*Sooyeon Lee 2019-12-01*/ //add print statement
	s := contract.Input
	// for i := range s {
	//  fmt.Printf(">>input : %x\n", contract.Input[i]])
	// }
	// /*Sooyeon Lee 2019-12-01*/ //checking constructor
	// for i := range contract.Input {
	//  if(contract.Input[i] = 0x39){ //if has codecopy is wouldbe constructor
...
<<<<<<< HEAD
	...
	fmt.Printf(">>using getDataBig : %x\n", getDataBig(s, big.NewInt(0), big.NewInt(4)))
	// Reclaim the stack as an int pool when the execution stops
	defer func() { in.intPool.put(stack.data...) }()

=======
>>>>>>> 706f5e3b98a419e8b93653d21876b74a60ab3ee6
	if in.cfg.Debug {
		defer func() {
			if err != nil {
				if !logged {
<<<<<<< HEAD
					//Sooyeon LEE 2020.02.25 add argument fallback flag
...
<<<<<<< HEAD
		...
		// 	fmt.Printf("%s\n", "NonFallback option is on")
		// 	//fallbackFlag.StartingNonFallback = false
		// 	return nil, fmt.Errorf("%s", "nonfallback option is on")
		// }

		//Sooyeon LEE 2020.09.22
		if op == FORINITSTART && isCreation == false {
			fmt.Printf("%s\n", "not called by constructor")
			return nil, fmt.Errorf("%s", "not called by constructor")
		}
...
<<<<<<< HEAD
		...
		if op == STARTFALLBACK || op == NONFALLBACKON {
			fmt.Printf("%t, %t\n", fallbackFlag.IsNonFallBackEnforced, fallbackFlag.StartingNonFallback)
		}
		// if fallbackFlag.IsNonFallBackEnforced && fallbackFlag.StartingNonFallback {
		// 	fmt.Printf("%s\n", "NonFallback option is on")
		// 	//fallbackFlag.StartingNonFallback = false
